...
import org.flexunit.ant.tasks.types.CompilerConstants;
...
public class CompilationConfiguration implements StepConfiguration {
    ...
    {
        this.compilerConstants.add(constant);
    }
    public CompilerConstants getCompilerConstants() {
